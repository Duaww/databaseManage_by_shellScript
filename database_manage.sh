...
update_record() {
    echo -n "Enter the name table you want to update : "
    read tab_name
    echo
...
delete_record() {
    echo -n "Enter the name table you want to delete record : "
    read tab_name
    echo

    tab_name_data=${tab_name}_data

    echo -n "Enter the value have primary key : "
    read primary_key
    echo
...
delete_table() {
    echo -n "Enter the name table you want to delete : "
    read tab_name 
    echo
...
display_data() {
    echo -n "Enter the name of name data table : "
    read tab_name
    echo 
